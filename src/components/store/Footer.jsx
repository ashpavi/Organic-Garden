  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/+94709102573" className="group w-10 h-10 flex items-center justify-center rounded-full bg-gray-900 border border-gray-700 hover:bg-white transition">
              <svg className="w-4 h-4 text-gray-400 group-hover:text-black transition" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
        ...
        <p>Nature's Goodness for Healthy Living</p>
      </div>
    </footer>
  );
};
